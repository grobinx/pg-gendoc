--DROP FUNCTION gendoc.html_create_toc(aitems jsonb, aname character varying);
...
ALTER FUNCTION gendoc.html_create_toc(aitems jsonb, aname character varying) OWNER TO gendoc;
COMMENT ON FUNCTION gendoc.html_create_toc(aitems jsonb, aname character varying) IS 'Create table of content from jsonb array as HTML code';
